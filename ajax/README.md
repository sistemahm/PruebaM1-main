...
#### Pre-requisitos:
Antes de desarollar nuestro codigo de front-end necesitaremos un servidor al que pedirle los datos de nuestra app usando AJAX.
...
Una vez que hayas instalado NodeJs, ve al directorio `ajax` desde la terminal y corre estos dos comandos:
```shell
npm install
...
#### Tareas:
Escribe codigo en los archivos `index.html` y `index.js` para que la página tenga las siguientes funcionalidades:
